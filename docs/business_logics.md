...
+ Регистрация, авторизация, аутентификация пользователей для всех функциональных блоков;
...
## 2.6 Регистрация, авторизация, аутентификация пользователей для всех функциональных блоков
...
Дизайн сайта должен быть максимально простым и интуитивно понятным. Одновременно с этим дизайн должен обеспечивать доступ к восприятию и удобной обработке всего описанного выше функционала.
